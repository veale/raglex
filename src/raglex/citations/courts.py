...
COURTS: tuple[Court, ...] = (
    ...
    Court("NSWCATCD", "NSW Civil & Administrative Tribunal (Consumer & Commercial Division)", "AU"),
    Court("NSWCATGD", "NSW Civil & Administrative Tribunal (Guardianship Division)", "AU"),
    Court("NSWCATOD", "NSW Civil & Administrative Tribunal (Occupational Division)", "AU"),
    ...
    Court("NSWChC", "Children's Court of New South Wales", "AU"),
    Court("NSWCC", "Compensation Court of New South Wales", "AU"),
    Court("NSWDRGC", "Drug Court of New South Wales", "AU"),
    Court("NSWLC", "Local Court of New South Wales", "AU"),
    Court("NSWDDT", "Dust Diseases Tribunal of New South Wales", "AU"),
    Court("NSWLST", "Legal Services Tribunal of New South Wales", "AU"),
    Court("NSWMT", "Medical Tribunal of New South Wales", "AU"),
    Court("NSWTAB", "New South Wales Transport Appeal Boards", "AU"),
    Court("NSWIC", "Industrial Court of New South Wales", "AU"),
    Court("IRCA", "Industrial Relations Court of Australia", "AU"),
    Court("ACompT", "Australian Competition Tribunal", "AU"),
    Court("ACopyT", "Copyright Tribunal of Australia", "AU"),
    Court("ADFDAT", "Defence Force Discipline Appeal Tribunal", "AU"),
    Court("AFDAT", "Defence Force Discipline Appeal Tribunal", "AU"),
    Court("AFPDT", "Federal Police Disciplinary Tribunal", "AU"),
    Court("NFSC", "Supreme Court of Norfolk Island", "AU"),
    Court("ATPT", "Australian Trade Practices Tribunal", "AU"),
